...
function Payment(){
    ...
    const createPayment = () =>{
        ...
        axios.post(`http://${process.env.REACT_APP_IP}:8080/bababook/user/${userId}/payment`, paymentPost)
        .then((response) => {
                                ...
                                <div className="row">
                                    <div className="col">
                                        ...
                                        <div className="input-group mb-3">
                                            ...
                                            <input type="text" className="form-control" pattern="\d*" id="exp" maxlength="5" placeholder="MM/YY" name="exp" onChange={handleChangeInput}/>
                                        </div>
                                    </div>
