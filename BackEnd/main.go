...
func main() {
	...
	e.Use(middleware.CORSWithConfig(middleware.CORSConfig{
		...
		//AllowOrigins: []string{"*"},
		AllowOrigins: []string{"http://localhost:3000/", "http://localhost:3000", "http://ec2-18-138-251-129.ap-southeast-1.compute.amazonaws.com:3000/", "http://ec2-18-138-251-129.ap-southeast-1.compute.amazonaws.com:3000", "http://bababook-lb-541570129.ap-southeast-1.elb.amazonaws.com/"},
